...
<body>
    <?php if (isset($_GET['added'])): ?>
        <script>
            alert("Đã thêm sản phẩm: <?= $_GET['name'] ?> vào giỏ hàng!");
        </script>
    <?php endif; ?>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="product-main">
                                    ...
                                    <div class="col-md-3 col-sm-6 text-center">
                                        <div class="thumbnail">
                                            <div class="hoverimage1">
                                                <img src="<?php echo $kq['image']; ?>" alt="<?php echo $kq['name']; ?>" width="100%" height="300">
                        ...
                        <div class="content-product-main">
                            <div class="row">
                                <?php
                                $sql = "SELECT id,image,name,price FROM products WHERE category_id=1 LIMIT 20";
                                $result = mysqli_query($conn, $sql);
                                ...
                                ?>
                                    <div class="col-md-3 col-sm-6 text-center">
                                        <div class="thumbnail">
                                            <div class="hoverimage1">
                                                <img src="<?php echo str_replace('../', '', $kq['image']); ?>" alt="<?php echo $kq['name']; ?>" width="100%" height="300">
                                            </div>
                                            <div class="name-product">
                                                <?php echo $kq['name']; ?>
                                            </div>
                        ...
                        <div class="content-product-main">
                            <div class="row">
                                <?php
                                $sql = "SELECT id,image,name,price FROM products WHERE category_id=2 LIMIT 20";
                                $result = mysqli_query($conn, $sql);
